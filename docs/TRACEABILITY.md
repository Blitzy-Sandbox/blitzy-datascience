...
| F-009 | Players pipeline; emits `players.csv` and `player_tracking.csv` from 5 endpoints | Rule 4, Rule 5, Rule 7 | Gate 1 | `pipelines/ingest_players.py`, `endpoints/players.py` | `tests/unit/pipelines/test_ingest_players.py`, `tests/unit/endpoints/test_players.py` |
| F-010 | Teams pipeline; emits `teams.csv` from 3 endpoints | Rule 4, Rule 5, Rule 7 | Gate 1 | `pipelines/ingest_teams.py`, `endpoints/teams.py` | `tests/unit/pipelines/test_ingest_teams.py`, `tests/unit/endpoints/test_teams.py` |
...
| F-012 | Lineups pipeline; emits `lineups.csv` from 2 endpoints | Rule 4, Rule 5, Rule 7 | Gate 1 | `pipelines/ingest_lineups.py`, `endpoints/lineups.py` | `tests/unit/pipelines/test_ingest_lineups.py`, `tests/unit/endpoints/test_lineups.py` |
